        ...
        <div className="auth-container" style={{ flexDirection: "column", gap: "2rem" }}>
            <div style={{ textAlign: "center", maxWidth: "540px" }}>
                ...
                <p style={{ color: "var(--text-muted)", fontSize: "1rem" }}>
                    Sign in through the portal for your account. The same email can be used across patient, doctor, and pharmacist accounts, but each portal signs you into its own role.
                </p>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1rem", width: "100%", maxWidth: "860px" }}>
                ...
                >
                    ...
                    <h2 style={{ margin: 0, color: "#134e4a", fontSize: "1.35rem" }}>Patient Portal</h2>
                ...
                >
                    ...
                    <p style={{ marginTop: "0.75rem", color: "var(--text-muted)", lineHeight: 1.6 }}>
                        Manage patients, prescriptions, doctor-added records, and consent-based access to patient data.
                    </p>
                </Link>
